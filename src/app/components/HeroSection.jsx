    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        <div className="col-span-5 place-self-center mt-4 lg:mg-0">
          <motion.div initial={{ opacity: 0, scale:0.5 }} animate={{ opacity:1, scale:1 }}  transition={{ duration:1 }} className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
