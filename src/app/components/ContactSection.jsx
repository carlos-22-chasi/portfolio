    ...
    <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2 mt-10">
          <Link href="https://github.com/carlos-22-chasi" target="_blank" rel="noopener noreferrer" >
            <Image 
              src={GithubIcon} 
              alt="Github Icon" 
              className="w-12 transition-transform duration-100 ease-in-out hover:-translate-y-2 active:rotate-180"/>
          </Link>
          <Link href="https://www.linkedin.com/in/carlos-c-18ab47230" target="_blank" rel="noopener noreferrer" >
            <Image 
              src={LinkedinIcon} 
              alt="Linkedin Icon" 
              className="w-14 transition-transform duration-100 ease-in-out hover:-translate-y-2 active:rotate-180"/>
          </Link>
        </div>
      </div>
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                id="subject"
                required
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5 hover:border-blue-200"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                id="message"
                rows={4}
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5 hover:border-red-200"
